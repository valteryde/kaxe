...
Dette er derfor legacy per 12 jan 2024
                 ______
           _____/      \\_____
          |  _     ___   _   ||
          | | \     |   | \  ||
...
from .core.styles import AttrObject, ComputedAttribute
from .core.text import Text, getTextDimension
...
class VectorAxis(AttrObject):
    ...
    def finalize(self, parent, visualOffset:tuple=(0,0)):
        ...
        startPos = self.getAttr('startPos')
        endPos = self.getAttr('endPos')
        if not startPos or not endPos:
            ...
            self.p1, self.p2 = p1, p2 = startPos, endPos
...
class AxisPlot(Window):
    ...
    def __init__(self,  window:list=None, trueAxis:bool=None): # |
        ...
        self.attrmap.submit(VectorAxis)
        self.attrmap.submit(Marker)


    # creating plotting window
    def __setWindowDimensionBasedOnAxis__(self, firstAxis:VectorAxis, secondAxis:VectorAxis):
    ...
    def __createStandardAxis__(self):
        ...
        self.firstAxis = VectorAxis((1,0))
        self.secondAxis = VectorAxis((0,1))
    ...
    def setAxis(self, first:VectorAxis, second:VectorAxis):
